...
export function createMistral(options: MistralProviderSettings = {}): MistralProvider {
  ...
  const createChatModel = (modelId: MistralChatModelId, settings: MistralChatSettings = {}) =>
  ...
  const provider = function (modelId: MistralChatModelId, settings?: MistralChatSettings) {
    if (new.target) {
